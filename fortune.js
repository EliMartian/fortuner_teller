...
function calculateStock(response) {
    ...
    if (document.getElementById('stocks_container').childElementCount === 4) {
        ...
        let userInvestedDateValue = document.getElementById("date_invested_field").value;
        let userInvestedDate = userInvestedDateValue.split("-");
